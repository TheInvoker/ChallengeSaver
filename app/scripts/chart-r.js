$(document).ready(function() {
				...
				var drawDashedLine = function() {
					ctx.save();
					var pointsGr = myLineChart.datasets[0].points;
					ctx.beginPath();
					ctx.moveTo(pointsGr[5].x,pointsGr[5].y);
					ctx.lineTo(pointsGr[6].x,pointsGr[6].y);
					ctx.lineWidth=2;
					ctx.strokeStyle = 'wihte';
					ctx.setLineDash([5]);
					ctx.stroke();
					ctx.setLineDash([]);
					ctx.restore();
				...
				var points = [-28, -48, -40, -19, -86, -27, -90];
